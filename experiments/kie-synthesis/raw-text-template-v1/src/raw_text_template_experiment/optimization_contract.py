...
DISCRIMINATED_BINDING_ADAPTER = TypeAdapter(DiscriminatedBindingProposal)
...
def discriminate_binding(
    ...
    return DiscriminatedBindingProposal(**common, rendering=rendering)
...
DISCRIMINATED_CRITIC_ADAPTER = TypeAdapter(DiscriminatedCriticOutput)
...
def discriminate_critic(
    ...
    if legacy.verdict == "pass":
        return CriticPassOutput(verdict="pass", rationale=legacy.rationale)
